...
def run_model_pipeline_with_pseudo_labels():
    """
    Function that runs the NBME pipeline with pseudo-labeled
    data
    """
    # Load in the data
    print("Loading configuration and data")
    ...
    for epoch in range(7):
        ...
        # Save the model after each epoch
        PATH = f"./models/deberta_v3_base_cpt_epoch_{epoch}_pl.pt"
        torch.save(model.state_dict(), PATH)
